...
public class EntityCreateCollectionRequest
    extends BaseEvent
{
    ...
    @JsonPropertyDescription("Data payloads containing entities to save.")
    private List<EntityCreatePayload> payloads = new ArrayList<EntityCreatePayload>();
    ...
    public EntityCreateCollectionRequest withDataFormat(DataFormat dataFormat) {
        this.dataFormat = dataFormat;
        return this;
    }
    ...
    public EntityCreateCollectionRequest withTransactionWindow(Integer transactionWindow) {
        this.transactionWindow = transactionWindow;
        return this;
    }
    ...
    public EntityCreateCollectionRequest withTransactionTimeoutMs(Long transactionTimeoutMs) {
        this.transactionTimeoutMs = transactionTimeoutMs;
        return this;
    }
     ...
     */
    @JsonProperty("payloads")
    public List<EntityCreatePayload> getPayloads() {
        return payloads;
    }
     ...
     */
    @JsonProperty("payloads")
    public void setPayloads(List<EntityCreatePayload> payloads) {
        this.payloads = payloads;
    }

    public EntityCreateCollectionRequest withPayloads(List<EntityCreatePayload> payloads) {
        this.payloads = payloads;
        return this;
    }

    @Override
    public EntityCreateCollectionRequest withSuccess(Boolean success) {
        super.withSuccess(success);
        return this;
    }

    @Override
    public EntityCreateCollectionRequest withId(String id) {
        super.withId(id);
        return this;
    }

    @Override
    public EntityCreateCollectionRequest withError(Error error) {
        super.withError(error);
        return this;
    }

    @Override
    public EntityCreateCollectionRequest withWarnings(List<String> warnings) {
    ...
    public String toString() {
        ...
        sb.append(EntityCreateCollectionRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EntityCreateCollectionRequest) == false) {
            return false;
        }
        EntityCreateCollectionRequest rhs = ((EntityCreateCollectionRequest) other);
