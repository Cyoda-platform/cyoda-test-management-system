...
public class ProcessorInfo {
    ...
    public ProcessorInfo withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ProcessorInfo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProcessorInfo) == false) {
            return false;
        }
        ProcessorInfo rhs = ((ProcessorInfo) other);
