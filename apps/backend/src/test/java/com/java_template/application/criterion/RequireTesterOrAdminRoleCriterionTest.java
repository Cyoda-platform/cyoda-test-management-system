...
class RequireTesterOrAdminRoleCriterionTest {
    ...
    private final RequireTesterOrAdminRoleCriterion criterion = new RequireTesterOrAdminRoleCriterion(serializerFactory);
